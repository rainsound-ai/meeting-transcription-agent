...
async def summarize_transcription(request: TranscriptionRequest):
    try:
        ...
        final_prompt = f"""
        You will be provided with several summaries of a meeting transcription. 
        These summaries were generated by splitting the transcription into chunks to avoid rate limit issues. Your task is to consolidate them into a single, coherent summary.
        ...
        Sometimes the meetings include external people like customers or partners - do your best to capture them as well.
